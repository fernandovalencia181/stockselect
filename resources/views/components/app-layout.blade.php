        ...
        <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 pt-10 pb-32 md:pt-20 md:pb-16">
            ...
            <div class="lg:hidden">
                ...
                <div class="flex flex-col gap-2.5 mb-6 pb-6 border-b border-white/5">
                    ...
                    <div class="flex items-center gap-2.5 text-[11px] font-semibold text-gray-500 uppercase tracking-widest">
                        <svg class="w-3.5 h-3.5 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
                        Envío Gratis desde {{ round($settings['shipping_free_threshold'] ?? 50) }}€
                    </div>
                    <div class="flex items-center gap-2.5 text-[11px] font-semibold text-gray-500 uppercase tracking-widest">
            ...
            <div class="hidden lg:grid lg:grid-cols-4 lg:gap-8">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-2.5">
                        ...
                        <div class="flex items-center gap-2.5 text-[11px] font-semibold text-gray-500 uppercase tracking-widest">
                            <svg class="w-3.5 h-3.5 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                            Envío Gratis desde {{ round($settings['shipping_free_threshold'] ?? 50) }}€
                        </div>
                        <div class="flex items-center gap-2.5 text-[11px] font-semibold text-gray-500 uppercase tracking-widest">
