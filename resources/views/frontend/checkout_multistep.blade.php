<x-app-layout>
    <div class="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8 font-sans"
        x-data="{ 
            ...
            init() {
                // Vigilante para el Email: Si cambia y hay un cup├│n puesto, re-validamos
        ...
        <div class="mb-12 relative">
            <div class="flex items-center justify-between max-w-2xl mx-auto relative">
                ...
                <div class="relative z-10 flex flex-col items-center gap-2 group" :class="maxStepReached >= 2 ? 'cursor-pointer' : 'opacity-50 cursor-not-allowed'" @click="if(maxStepReached >= 2) goToStep(2)">
                    ...
                    <span class="text-[11px] font-bold uppercase tracking-widest transition-colors duration-300"
                        :class="step >= 2 ? 'text-black' : 'text-gray-400'">Env├¡o</span>
                </div>
                {{-- Step 3 --}}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-400">Introduce la informaci├│n b├ísica para tu pedido.</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold uppercase tracking-widest text-gray-400 mb-2">Tel├®fono (WhatsApp)</label>
                ...
                <div class="lg:col-span-2 space-y-8" x-show="step === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4">
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h2 class="text-xl font-extrabold text-gray-900">Opciones de Env├¡o</h2>
                                <p class="text-sm text-gray-400">C├│mo quieres recibir tus productos.</p>
                            </div>
                        </div>
                            ...
                            <label class="flex items-center justify-between p-5 border-2 rounded-2xl cursor-pointer transition-all hover:bg-gray-50"
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-xs text-gray-400">Env├¡o r├ípido a domicilio o punto pack.</span>
                                    </div>
                                </div>
                                <span class="font-extrabold text-[15px]" x-text="(subtotal >= threshold) ? 'Gratis' : shippingCostValue.toFixed(2) + ' Ôé¼'"></span>
                            </label>
                            ...
                            <label class="flex items-center justify-between p-5 border-2 rounded-2xl cursor-pointer transition-all hover:bg-gray-50"
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-xs text-gray-400">Pasa por nuestra sede y ahorra el env├¡o.</span>
                                    </div>
                                </div>
                        ...
                        <div x-show="shippingMethod === 'standard_delivery'" x-transition class="space-y-6 pt-6 border-t border-gray-50">
                            <h3 class="text-base font-bold text-gray-900">┬┐D├│nde lo enviamos?</h3>
                            
                            <div class="relative">
                                <label class="block text-[11px] font-bold uppercase tracking-widest text-gray-400 mb-1">Buscar tu direcci├│n</label>
                                        ...
                                        <button type="button" @click="selectAddress(feature)"
                                            ...
                                            <div class="flex flex-col min-w-0">
                                                ...
                                                <span class="text-[11px] text-gray-400 mt-0.5"
                                                    x-text="[feature.properties.city || feature.properties.town || feature.properties.village || '', feature.properties.county || feature.properties.state || '', feature.properties.postcode ? 'CP ' + feature.properties.postcode : ''].filter(Boolean).join(' ┬À ')"></span>
                                            </div>
                                        </button>
                                    </template>
                                </div>

                                {{-- Confirmaci├│n visual de direcci├│n seleccionada --}}
                                <div x-show="shippingStreet && !searchResults.length"
                                    ...
                                    Direcci├│n cargada. Revisa y completa los campos si es necesario.
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-4 gap-x-6 gap-y-6">
                                ...
                                <div class="sm:col-span-1">
                                    <div class="flex flex-col justify-end min-h-[48px] mb-2">
                                        <label class="block text-[11px] font-bold uppercase tracking-widest text-gray-400">N┬║</label>
                                    </div>
                                ...
                                {{-- Fila 3: C├│digo Postal y Provincia --}}
                                <div class="sm:col-span-2">
                                    <div class="flex flex-col justify-end min-h-[48px] mb-2">
                                        <label class="block text-[11px] font-bold uppercase tracking-widest text-gray-400">C├│digo Postal</label>
                                    </div>
                                ...
                                <div class="sm:col-span-4">
                                    ...
                                    <textarea name="shipping_notes" x-model="shippingNotes" rows="3"
                                        placeholder="Ej: Es una casa blanca con port├│n azul, llamar al timbre 4..."
                        ...
                        <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-between">
                            <button type="button" @click="goToStep(1)" class="text-gray-400 font-bold px-8 py-4 hover:text-black transition">ÔåÉ Volver atr├ís</button>
                ...
                <div class="lg:col-span-2 space-y-8" x-show="step === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4">
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-3">
                            {{-- Opción Stripe --}}
                            <label class="flex items-start gap-4 p-5 border-2 rounded-2xl cursor-pointer transition-all hover:bg-gray-50"
                                :class="paymentMethod === 'stripe' ? 'border-black bg-gray-50/80' : 'border-gray-100'">
                                <input type="radio" name="_payment_ui" value="stripe"
                                    x-model="paymentMethod"
                                    class="mt-1 h-4 w-4 text-black focus:ring-black shrink-0">
                                <div class="flex-1">
                                    <div class="flex items-center justify-between flex-wrap gap-2 mb-1">
                                        <span class="font-extrabold text-gray-900 text-[15px]">Tarjeta, Bizum o Klarna</span>
                                        <img src="{{ asset('images/logo-stripe.png') }}" alt="Stripe" class="h-5 opacity-70">
                                    </div>
                                    <p class="text-xs text-gray-500 leading-relaxed">
                                        Pago 100% seguro a través de Stripe. Acepta tarjetas Visa, Mastercard, Amex, Bizum y pago a plazos con Klarna.
                                    </p>
                                    <div class="flex items-center gap-3 mt-2 pt-2 border-t border-gray-100 text-[11px] text-gray-400 font-semibold flex-wrap">
                                        <span class="flex items-center gap-1">🔒 SSL cifrado</span>
                                        <span class="text-gray-200">&bull;</span>
                                        <span class="flex items-center gap-1">💳 Sin cargos extra</span>
                                        <span class="text-gray-200">&bull;</span>
                                        <span class="flex items-center gap-1">⚡ Confirmación instantánea</span>
                                    </div>
                                </div>
                            </label>

                            {{-- Opción WhatsApp / Efectivo --}}
                            <label class="flex items-start gap-4 p-5 border-2 rounded-2xl cursor-pointer transition-all hover:bg-gray-50"
                                :class="paymentMethod === 'whatsapp' ? 'border-black bg-gray-50/80' : 'border-gray-100'">
                                <input type="radio" name="_payment_ui" value="whatsapp"
                                    x-model="paymentMethod"
                                    class="mt-1 h-4 w-4 text-black focus:ring-black shrink-0">
                                <div class="flex-1">
                                    <div class="flex items-center justify-between flex-wrap gap-2 mb-1">
                                        <span class="font-extrabold text-gray-900 text-[15px]">Efectivo al recibir</span>
                                        <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20">
                                    ...
                                    <p class="text-xs text-gray-500 leading-relaxed">
                                        Coordinamos la entrega por WhatsApp y pagas en efectivo al recibir tu pedido. Sin tarjeta requerida.
                                    </p>
                                    <div class="flex items-center gap-3 mt-2 pt-2 border-t border-gray-100 text-[11px] text-gray-400 font-semibold flex-wrap">
                                        <span class="flex items-center gap-1">🤝 Trato directo</span>
                                        <span class="text-gray-200">&bull;</span>
                                        <span class="flex items-center gap-1">💶 Sin tarjeta</span>
                                        <span class="text-gray-200">&bull;</span>
                                        <span class="flex items-center gap-1">📍 Coordinación por chat</span>
                                    </div>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 bg-gray-50/80 border border-gray-100 rounded-2xl px-5 py-3 mt-4">
                            <img src="{{ asset('images/payments/visa.svg') }}?v=3" alt="Visa" class="h-4 w-auto opacity-40 hover:opacity-70 transition-opacity">
                            <img src="{{ asset('images/payments/mastercard.svg') }}?v=3" alt="Mastercard" class="h-4 w-auto opacity-40 hover:opacity-70 transition-opacity">
                            <img src="{{ asset('images/payments/amex.svg') }}?v=3" alt="American Express" class="h-4 w-auto opacity-40 hover:opacity-70 transition-opacity">
                            <img src="{{ asset('images/payments/applepay_gris.svg') }}?v=2" alt="Apple Pay" class="h-4 w-auto opacity-40 hover:opacity-70 transition-opacity">
                            <img src="{{ asset('images/payments/googlepay_gris.svg') }}?v=2" alt="Google Pay" class="h-4 w-auto opacity-40 hover:opacity-70 transition-opacity">
                            <img src="{{ asset('images/payments/klarna.svg') }}?v=3" alt="Klarna" class="h-3.5 w-auto opacity-40 hover:opacity-70 transition-opacity">
                            <img src="{{ asset('images/payments/bizum.svg') }}?v=3" alt="Bizum" class="h-4 w-auto opacity-40 hover:opacity-70 transition-opacity">
                        </div>

                        <div class="mt-10 bg-gray-50 p-6 rounded-2xl border border-gray-100 relative">
                            ...
                            <button type="button" @click="submitOrder()"
                                ...
                                class="w-full text-white font-extrabold py-5 rounded-2xl transition-all shadow-xl active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100">
                                {{-- Estado normal: Stripe --}}
                                <template x-if="!isSubmitting && paymentMethod === 'stripe'">
                                ...
                                {{-- Estado normal: WhatsApp --}}
                                <template x-if="!isSubmitting && paymentMethod === 'whatsapp'">
                                    <span class="flex items-center gap-3 text-[15px] tracking-wide">
                    ...
                    <div class="bg-gray-50 p-6 rounded-3xl sticky top-6 border border-gray-200">
                        ...
                        <div class="space-y-4 mb-6 max-h-96 overflow-y-auto">
                            @foreach($cart as $item)
                                ...
                                <div class="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0">
                                    ...
                                    <p class="text-sm font-extrabold text-gray-900">{{ number_format($item['price'] * $item['quantity'], 2) }}Ôé¼</p>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="space-y-3 py-4 border-t border-gray-200 text-sm">
                            <div class="flex justify-between text-gray-500">
                                <span>Subtotal</span>
                                <span class="font-bold text-gray-900" x-text="(subtotal || 0).toFixed(2) + ' Ôé¼'"></span>
                            </div>
                            <div class="flex justify-between text-gray-500">
                                <span>Env├¡o</span>
                                <span :class="shippingCost === 0 ? 'text-green-600 font-bold' : 'font-bold text-gray-900'"
                                      x-text="shippingCost === 0 ? 'Gratis' : shippingCost.toFixed(2) + ' Ôé¼'"></span>
                            </div>

                            <template x-if="discountAmount > 0">
                                <div class="flex justify-between text-green-600 font-bold animate-pulse">
                                    <span>Descuento</span>
                                    <span x-text="'-' + discountAmount.toFixed(2) + ' Ôé¼'"></span>
                                </div>
                            </template>
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100 text-center" x-show="step < 3">
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.1em]">
                                ┬┐Tienes un cup├│n? Podr├ís canjearlo en el paso 3
                            </p>
                        </div>

                        {{-- SECCI├ôN CUP├ôN REFINADA --}}
                        <div class="mt-4 pt-4 border-t border-gray-100" x-show="step === 3" x-transition>
                            <div class="bg-gray-100/50 p-4 rounded-2xl">
                                <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2 block">┬┐Tienes un cup├│n?</label>
                                <div class="flex flex-col gap-2">
                                    <template x-if="!appliedCouponCode">
                                        <input type="text" x-model="couponCode" placeholder="Ingresa el c├│digo" 
                        ...
                        <div class="flex justify-between pt-4 border-t-2 border-dashed border-gray-200 mt-4">
                            ...
                            <span class="text-2xl font-black text-gray-900" x-text="total.toFixed(2) + ' Ôé¼'"></span>
                        </div>
                    </div>
                </div>
            </div>
