...
<head>
    ...
    <style>
        ...
        .status-box { background-color: #f0fdf4; border: 1px solid #86efac; border-radius: 12px; padding: 30px; margin: 30px 0; }
        .status-icon { font-size: 48px; margin-bottom: 15px; }
        .status-label { font-size: 12px; text-transform: uppercase; letter-spacing: 2px; color: #166534; margin-bottom: 10px; font-weight: bold; }
        .status-text { font-size: 18px; font-weight: 700; color: #14532d; }
        ...
        .cta-box { background-color: #000000; border-radius: 12px; padding: 30px; margin: 30px 0; }
        .cta-box p { color: #cccccc; font-size: 14px; margin-bottom: 15px; }
        .cta-box a { display: inline-block; background-color: #ffffff; color: #000000; text-decoration: none; font-weight: 900; font-size: 14px; padding: 14px 32px; border-radius: 8px; letter-spacing: 1px; text-transform: uppercase; }
        ...
        <table class="main" role="presentation">
            ...
            <tr>
                <td class="content">
                    ...
                    <p>Te confirmamos que tu pedido <strong>#{{ $order->id }}</strong> ha sido entregado con éxito. ¡Esperamos que disfrutes de tus nuevos artículos!</p>
                    ...
                    <div class="cta-box">
                        <p>¿Te ha gustado tu compra? ¡Echa un vistazo a nuestras últimas novedades!</p>
                        <a href="{{ config('app.url') }}">Ver Novedades</a>
                    </div>

                    <p style="font-size: 14px; color: #999999;">Si hay algún problema con tu pedido o necesitas una devolución, no dudes en contactarnos por WhatsApp o respondiendo a este correo. ¡Estamos para ayudarte!</p>
                </td>
            </tr>
            <tr>
                <td class="footer">
